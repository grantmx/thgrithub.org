		...
		<>
			...
			<main className="container-fluid d-flex p-0 flex-column">
				...
				<section className="container-xxl col-12 d-flex justify-content-center align-items-center p-5 flex-column" id="about">
					<h1 className="fw-bold display-4 mb-4 text-center">The Grit Foundation, Inc.</h1>
					<div className="text-center col-xl-10 col-12">
						<p className="lead">We are a Non-Profit Company with a mission to be a catalyst for providing training, programming and mentoring services in the business ecosystem through our system of GRIT Hubs.</p>
